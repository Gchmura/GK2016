// z2p2.cpp : Defines the entry point for the console application.
//
...
static GLboolean iCull, iDepth, iOutline, iShade;
...
void RenderScene(void)
{
	...
	for (angle = 0.0f; angle < (3.0f*GL_PI); angle += (GL_PI / 3.0f))
	{
...
void Menu(int value)
{
	...
	case GL_SHADE_MODEL:
		iShade = !iShade;
		glutSetWindowTitle("Stozek - GL_SHADE MODEL");
		RenderScene();
		break;
...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("Triangles Constructing Piramid");
	...
	glutAddMenuEntry("GL_SHADE_MODEL", GL_SHADE_MODEL);
